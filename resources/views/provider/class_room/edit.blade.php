    ...
    <div class="container">
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    <h3 class="fw-bold mb-3">{{ __('message.Edit Class Room') }}</h3>
                    <h6 class="op-7 mb-2">4P</h6>
                </div>
            </div>
            <form action="{{ route('provider.class-rooms.update', $classRoom->id) }}" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                <div
                                                    ...
                                                    <input type="text" class="form-control" id="name_arabic"
                                                        name="name_arabic" value="{{ $classRoom->name_arabic }}" required>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div
                                                    ...
                                                    <input type="text" class="form-control" id="name_english"
                                                        name="name_english" value="{{ $classRoom->name_english }}" required>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div
                                                    ...
                                                    <input type="number" class="form-control" id="sort_order"
                                                        name="sort_order" min="0" value="{{ $classRoom->sort_order }}"
                                                        required>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <select
                                                    ...
                                                    @foreach($educationDepartments as $educational_department)
                                                        <option value="{{ $educational_department->id }}" {{ $educational_department->id == $classRoom->education_department_id ? 'selected' : ''}}>
                                                            @if(app()->getLocale() == 'ar')
