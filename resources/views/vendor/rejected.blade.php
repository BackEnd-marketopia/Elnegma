...
<head>
    ...
    <title>{{ __('message.rejected_title') }}</title>
...
<body class="bg-light d-flex align-items-center justify-content-center vh-100">
    ...
    <div class="bg-white p-4 rounded shadow text-center position-relative" style="max-width: 500px;">
        ...
        <h1 class="text-danger fw-bold">🚫 {{ __('message.rejected_title') }}</h1>
        <p class="text-secondary">
            {{ __('message.rejected_message') }}
        </p>

        <div class="mt-3">
            <svg class="w-25 h-25 text-danger animate-pulse" fill="none" stroke="currentColor" stroke-width="2"
        ...
        <p class="text-muted mt-3">{{ __('message.rejected_warning') }}</p>
