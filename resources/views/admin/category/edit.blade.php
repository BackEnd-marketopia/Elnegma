                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group
                                                ...
                                                <input type="text" class="form-control" id="name_arabic"
                                                   value="{{ $category->name_arabic }}" name="name_arabic" required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group
                                                ...
                                                <input type="text" class="form-control" id="name_english"
                                                   value="{{ $category->name_english }}" name="name_english" required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="number" value="{{ $category->sort_order }}" min="1" class="form-control" id="sort_order"
