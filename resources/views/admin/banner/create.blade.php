...
@section('title', __('message.Add Banner'))
...
@section('breadcrumb')
    ...
    <span class="mx-2">/</span>
    <span>{{ __('message.Add Banner') }}</span>
@endsection
            ...
            <div class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <div>
                    ...
                    <p class="text-purple-200 mt-1 text-sm">
                        {{ __('message.Fill in the details below to create a new banner') }}
                    </p>
                </div>
            </div>
        </div>
            ...
            resetBtn.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        form.reset();
                        removeImagePreview();
                        nameEnglish.placeholder = '{{ __("message.Enter banner name in English") }}';
